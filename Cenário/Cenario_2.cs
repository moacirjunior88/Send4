...
{
    public class Cenario_2 : BaseTest
    {
        ...
        private string nomeProduto = "", quantidade = "2";
        private int typeSelectionProduto = 1, typeSelectionLocalDevolucao = 1;
        ...
        readonly private int avalicaoAtendimento = 4;
