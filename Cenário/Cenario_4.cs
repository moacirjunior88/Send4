...
{
    public class Cenario_4 : BaseTest
    {
        ...
        private string nomeProduto = "", quantidade = "1";
        private int typeSelectionProduto = 2, typeSelectionLocalDevolucao = 3;
        ...
        public void Caso_de_Teste_1()
        {
            ...
            if ((typeSelectionProduto == 0) || (typeSelectionProduto == 1))
            {
            ...
            else if(typeSelectionProduto == 2)
            {
                Assert.IsTrue(ConfigurationManager.AppSettings["NOMEPRODUTODOIS"] == listaNomeInformaçõesProdutos[0], "Validação realizada com sucesso");
                Assert.IsTrue(motivos == listaNomeInformaçõesProdutos[2], "Validação realizada com sucesso");
                Assert.IsTrue(acao == listaNomeInformaçõesProdutos[3], "Validação realizada com sucesso");
                Assert.IsTrue(comoPodemoResolver == RepleceString(listaNomeInformaçõesProdutos[4], "Comentário\r\n", ""), "Validação realizada com sucesso");
            }
